    ...
    <section className="bg-secondary px-4 py-20 text-secondary-foreground">
      <div className="mx-auto max-w-3xl">
        <h2 className="text-balance mb-10 text-center text-xl font-bold leading-tight text-white sm:text-2xl md:text-3xl">
          No fundo, você sabe que trabalha mais do que deveria, perde horas com tarefas repetitivas e ainda não sabe como usar a IA para ganhar tempo e dinheiro. E isso não é falta de capacidade sua, é que ninguém te mostrou o caminho certo.
        </h2>
